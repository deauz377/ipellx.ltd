...
urlpatterns = [
    ...
    path('products/performance/', views.product_performance_report, name='product_performance'),
    path('history/', views.business_history, name='business_history'),
    path('business-days/<str:business_date>/close/', views.close_business_day, name='close_business_day'),
    path('business-days/<str:business_date>/reopen/', views.reopen_business_day, name='reopen_business_day'),
